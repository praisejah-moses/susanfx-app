...
export default function BrandsSection() {
  return (
    <section
      className="py-16 bg-[var(--background-default)] relative overflow-hidden animate-fadeInUp"
      style={{
        backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='20' cy='20' r='2' fill='%23ffffff' opacity='0.05'/%3E%3C/svg%3E")`,
      }}
    >
